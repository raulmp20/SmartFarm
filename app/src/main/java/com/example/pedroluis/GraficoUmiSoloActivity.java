...
public class GraficoUmiSoloActivity extends AppCompatActivity {
    ...
    private void JoaoMqtt() {
        ...
        mqttAndroidClient.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String topic, MqttMessage mqttMessage) throws Exception {
                ...
                if (topic.equals("Smart_Farm/"+mqttHelper.getClientId()+"/Sensores/UmiSolo/MediasHoras")) {
                    val_inst = mqttMessage.toString();
                    valor = Float.parseFloat(val_inst);
                    BarEntry barEntry = new BarEntry(cont, valor);
                    barEntries.add(barEntry);
                    ...
                    barChart.getDescription().setText("Valores da Umidade do Solo");
                    barChart.getDescription().setTextColor(Color.BLUE);
                }


                if (topic.equals("Smart_Farm/"+mqttHelper.getClientId()+"/Sensores/UmiSolo/MediasDias")) {
                    val_inst = mqttMessage.toString();
                    valor = Float.parseFloat(val_inst);
                    BarEntry barEntry = new BarEntry(cont, valor);
                    barEntries.add(barEntry);
                ...
                if (topic.equals("Smart_Farm/"+mqttHelper.getClientId()+"/Sensores/UmiSolo/MediasSemanas")) {
                    val_inst = mqttMessage.toString();
                    valor = Float.parseFloat(val_inst);
                    BarEntry barEntry = new BarEntry(cont, valor);
                    barEntries.add(barEntry);
