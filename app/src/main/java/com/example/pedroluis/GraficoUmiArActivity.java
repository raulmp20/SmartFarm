...
public class GraficoUmiArActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        graph_1D.setOnClickListener(view -> {
            cont = 0;
            barEntries.clear();
            publish(idEstufa, "Smart_Farm/" + mqttHelper.getClientId() + "/Sensores/UmiAr/Grafico1D");
        });

        graph_1S.setOnClickListener(view -> {
            cont = 0;
            publish(idEstufa, "Smart_Farm/" + mqttHelper.getClientId() + "/Sensores/UmiAr/Grafico1S");
        });

        graph_1M.setOnClickListener(view -> {
            cont = 0;
            publish(idEstufa, "Smart_Farm/" + mqttHelper.getClientId() + "/Sensores/UmiAr/Grafico1M");
        });
        ...
        mqttAndroidClient.setCallback(new MqttCallbackExtended() {
            ...
            public void messageArrived(String topic, MqttMessage mqttMessage) throws Exception {
                ...
                if (topic.equals("Smart_Farm/"+mqttHelper.getClientId()+"/Sensores/UmiAr/MediasHoras")) {
                    ...
                    BarDataSet barDataSet = new BarDataSet(barEntries, "Umidade do Ar");
                    ...
                    barChart.getDescription().setText("Valores da Umidade do Ar");
